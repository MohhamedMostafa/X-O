...
function end(num1, num2 , num3){
    ...
    title.innerHTML =`${squares[num1]  }   SokoMoto  `
    document.getElementById('item' + num1).style.background = '#999'
    document.getElementById('item' + num2).style.background = '#999'
    document.getElementById('item' + num3).style.background = '#999'
...
function game(id){
let elemint = document.getElementById(id);
    if(turn == 'Emo' && elemint.innerHTML == '' ){
        elemint.innerHTML ='Emo';
        turn = 'Memo';
        elemint.style.color = '#000'
        title.innerHTML = '( Memo )'

    }else if(turn == 'Memo' && elemint.innerHTML == ''){
        elemint.innerHTML = 'Memo';
        turn = 'Emo';
        title.innerHTML = '( Emo )';
